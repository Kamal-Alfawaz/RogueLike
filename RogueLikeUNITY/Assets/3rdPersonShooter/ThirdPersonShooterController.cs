    ...
    private void Update(){
        ...
        if (starterAssetsInputs.shoot){
            ...
            if(Time.time >= nextTimeToFire){
                ...
                //generates an impact VFX on the face an object that was hit, then destroys the effect after 1 second
                GameObject impactEffect = Instantiate(ImpactEffect, raycastHit.point, Quaternion.LookRotation(raycastHit.normal));
